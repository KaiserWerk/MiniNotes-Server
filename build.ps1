$sourcecode = "cmd\mininotes-server\main.go"
$target = "build/mininotes-server"
# Windows, 64-bit
...
# Raspberry Pi
$env:GOOS = 'linux';   $env:GOARCH = 'arm'; $env:GOARM=5; go build -o "$($target)-arm5-raspi32"   -ldflags "-s -w" $sourcecode
# macOS
